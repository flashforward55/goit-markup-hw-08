...
// Implementaion of an animation by - WEAREFOREAL
// INSTAGRAM (https://www.instagram.com/weareforeal)
// https://www.instagram.com/p/B42DUECCpyN/

// Issues:
// The original animation has somewhat elastic or back easing
// But I used linear lerp to ease the movement. I need to find a way to implement elastc lerping

// you can help me out if know how to implement elastic lerping :)

// Github: https://github.com/devloop01/so-many-eyes
...
let eyeGLTF =
  'https://raw.githubusercontent.com/devloop01/so-many-eyes/main/public/models/eye_model.glb';
  ...
  initAnimation() {
    ...
    tl.fromTo(
      ...
      { x: 0, y: 0, z: 0 },
      {
        ...
        y: 1,
        z: 1,
        stagger: { grid: [EYE_AMOUNT, EYE_AMOUNT], from: 'center', amount: 0.35 },
      },
      'start'
    );
  }
